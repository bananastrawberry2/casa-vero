      ...
      <div className="container-page">
        <div className="flex items-center justify-between h-20 md:h-24">
            ...
            {navLinks.map(({ href, label }) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(href)
                    ? solid ? "text-wood-600" : "text-white"
                    : solid ? "text-stone-500 hover:text-stone-800" : "text-white/70 hover:text-white"
                )}
              >
                {t(label)}
                {isActive(href) && (
          ...
          <div className="flex items-center gap-3">
            <div className={solid ? "text-stone-600" : "text-white/80"}>
              <LanguageSwitcher />
            </div>
            <Link
              href={`/${locale}/cart`}
              className={cn(
                ...
                solid ? "text-stone-600 hover:text-stone-800" : "text-white/80 hover:text-white"
              )}
            >
            ...
            <button
              className={cn(
                ...
                solid ? "text-stone-600" : "text-white/80"
              )}
